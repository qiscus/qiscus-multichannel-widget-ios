...
class UIChatViewController: UIViewController {
    ...
    public init() {
        super.init(nibName: "UIChatViewController", bundle: QiscusMultichannelWidget.bundle)
    }
...
//        disableInput.delegate = self
    ...
    private func setupTableView() {
        ...
        self.registerClass(nib: UINib(nibName: "QTextRightCell", bundle:QiscusMultichannelWidget.bundle), forMessageCellWithReuseIdentifier: "qTextRightCell")
        self.registerClass(nib: UINib(nibName: "QTextLeftCell", bundle:QiscusMultichannelWidget.bundle), forMessageCellWithReuseIdentifier: "qTextLeftCell")
        self.registerClass(nib: UINib(nibName: "QImagesRightCell", bundle:QiscusMultichannelWidget.bundle), forMessageCellWithReuseIdentifier: "qImagesRightCell")
        self.registerClass(nib: UINib(nibName: "QFileRightCell", bundle:QiscusMultichannelWidget.bundle), forMessageCellWithReuseIdentifier: "qFileRightCell")
         self.registerClass(nib: UINib(nibName: "QFileLeftCell", bundle:QiscusMultichannelWidget.bundle), forMessageCellWithReuseIdentifier: "qFileLeftCell")
        self.registerClass(nib: UINib(nibName: "QImagesLeftCell", bundle:QiscusMultichannelWidget.bundle), forMessageCellWithReuseIdentifier: "qImagesLeftCell")
        self.registerClass(nib: UINib(nibName: "QLocationLeftCell", bundle:QiscusMultichannelWidget.bundle), forMessageCellWithReuseIdentifier: "qLocationLeftCell")
        self.registerClass(nib: UINib(nibName: "QLocationRightCell", bundle:QiscusMultichannelWidget.bundle), forMessageCellWithReuseIdentifier: "qLocationRightCell")
        self.registerClass(nib: UINib(nibName: "QReplyLeftCell", bundle:QiscusMultichannelWidget.bundle), forMessageCellWithReuseIdentifier: "qReplyLeftCell")
